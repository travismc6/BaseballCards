    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles()
        {
            ...
            CreateMap<CollectionCard, CardsForListDto>()
                ...
                .ForMember(x => x.Image, opt => { opt.MapFrom(src => src.Photos != null && src.Photos.Any() ? src.Photos.First().Url : "https://st4.depositphotos.com/1020091/20129/v/1600/depositphotos_201293330-stock-illustration-baseball-card-icon-flat-color.jpg");  })
